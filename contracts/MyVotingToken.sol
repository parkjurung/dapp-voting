...
contract VoteInterface {
    ...
    function votedYes() public view returns (uint256 _votedYes);
    function votedNo() public view returns (uint256 _votedNo);
...
contract MyVotableToken is BasicToken, Ownable, VoteInterface {
    ...
    function votedYes() public view returns (uint256) {
        return votedYes_;
    }
    function votedNo() public view returns (uint256) {
        return votedNo_;
    }

    function votedResult() public view returns (VoteState) {
        if (votedYes() > votedNo()){
            return VoteState.Yes;
        }
        else if (votedNo() > votedYes()){
            return VoteState.No;
        }
        else if (votedNo() == votedYes()){
            return VoteState.Draw;
        }
        else {
    ...
    function getVotingState() public view returns(uint256 _votedYes, uint256 _votedNo){
